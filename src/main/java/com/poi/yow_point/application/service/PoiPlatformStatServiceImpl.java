...
public class PoiPlatformStatServiceImpl implements PoiPlatformStatPort {
    ...
    public Mono<PoiPlatformStatDTO> createStat(PoiPlatformStatDTO statDTO) {
        ...
        return Mono.just(statDTO)
                .map(dto -> {
                    PoiPlatformStatEntity entity = mapper.toEntity(dto);
                ...
                .flatMap(entity -> entityTemplate.insert(PoiPlatformStatEntity.class)
                        .using(entity)
                        .map(mapper::toDTO))
    ...
    public Mono<PoiPlatformStatDTO> updateStat(UUID statId, PoiPlatformStatDTO statDTO) {
        ...
        return repository.findById(statId)
                ...
                .map(existingStat -> {
                    PoiPlatformStatEntity updatedStat = mapper.toEntity(statDTO);
