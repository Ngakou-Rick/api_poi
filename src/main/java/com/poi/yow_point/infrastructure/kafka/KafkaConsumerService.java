...
public class KafkaConsumerService {
    ...
    public void listenPoiCreated(PointOfInterestDTO poi) {
        log.info("Received POI created event: {}", poi);
    }

    @KafkaListener(topics = "poi-updated", groupId = "yow_point_group")
    public void listenPoiUpdated(PointOfInterestDTO poi) {
        log.info("Received POI updated event: {}", poi);
    }

    @KafkaListener(topics = "poi-deleted", groupId = "yow_point_group")
    public void listenPoiDeleted(PointOfInterestDTO poi) {
        log.info("Received POI deleted event: {}", poi);
    }
}
