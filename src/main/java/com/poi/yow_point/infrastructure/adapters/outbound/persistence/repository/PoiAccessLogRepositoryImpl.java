...
public class PoiAccessLogRepositoryImpl implements PoiAccessLogRepositoryCustom {
    ...
    @Override
    public Flux<PoiAccessLogEntity> findByPoiId(UUID poiId) {
        ...
        return template.select(PoiAccessLogEntity.class)
                .matching(query)
                .all();
    }

    @Override
    public Flux<PoiAccessLogEntity> findByOrganizationId(UUID organizationId) {
    ...
    @Override
    public Flux<PoiAccessLogEntity> findByUserId(UUID userId) {
    ...
    @Override
    public Flux<PoiAccessLogEntity> findByAccessType(String accessType) {
    ...
    @Override
    public Flux<PoiAccessLogEntity> findByPlatformType(String platformType) {
    ...
    @Override
    public Flux<PoiAccessLogEntity> findByPoiIdAndOrganizationId(UUID poiId, UUID organizationId) {
    ...
    @Override
    public Flux<PoiAccessLogEntity> findByAccessDatetimeBetween(OffsetDateTime startDate, OffsetDateTime endDate) {
    ...
    @Override
    public Flux<PoiAccessLogEntity> findRecentByPoiId(UUID poiId, OffsetDateTime since) {
    ...
    @Override
    public Flux<PoiAccessLogEntity> findByPoiIdWithPagination(UUID poiId, int limit, int offset) {
     ...
     */
    public Flux<PoiAccessLogEntity> findByMetadataContains(String key, String value) {
        ...
        return databaseClient.sql("""
                ...
                .bind("key", key)
                .bind("value", value)
                .map(row -> PoiAccessLogEntity.builder()
