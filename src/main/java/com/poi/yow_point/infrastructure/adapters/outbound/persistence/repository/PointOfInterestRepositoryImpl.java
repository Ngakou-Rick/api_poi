...
public class PointOfInterestRepositoryImpl implements PointOfInterestRepositoryCustom {
        ...
        public Flux<PointOfInterestEntity> findByLocationWithinRadius(Double latitude, Double longitude, Double radiusKm) {
                ...
                return entityTemplate.getDatabaseClient()
                                ...
                                .map((row, metadata) -> entityTemplate.getConverter().read(PointOfInterestEntity.class, row,
                                                metadata))
                                .all();
        }
        ...
        public Mono<Long> deactivateById(UUID poiId) {
                return entityTemplate.update(PointOfInterestEntity.class)
        ...
        public Mono<Boolean> existsByNameAndOrganizationIdExcludingId(String name, UUID organizationId,
                ...
                return entityTemplate.exists(Query.query(criteria), PointOfInterestEntity.class);
        }
}