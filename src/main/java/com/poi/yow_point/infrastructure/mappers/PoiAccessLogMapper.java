...
public class PoiAccessLogMapper {
    ...
    /**
     * Convertit une entité PoiAccessLogEntity en DTO
     */
    public Mono<PoiAccessLogDTO> toDTO(PoiAccessLogEntity entity) {
     ...
     */
    public Mono<PoiAccessLogEntity> toEntity(PoiAccessLogDTO dto) {
        return Mono.fromCallable(() -> {
            if (dto == null) {
                return null;
            }
     ...
     */
    public Flux<PoiAccessLogDTO> toDTOFlux(Flux<PoiAccessLogEntity> entities) {
     ...
     */
    public Flux<PoiAccessLogEntity> toEntityFlux(Flux<PoiAccessLogDTO> dtos) {
     ...
     */
    public Mono<PoiAccessLogEntity> updateEntityFromDTO(PoiAccessLogEntity existingEntity, PoiAccessLogDTO dto) {
        return Mono.fromCallable(() -> {
