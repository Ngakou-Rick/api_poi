...
public class PointOfInterestMapper {
    ...
    /**
     * Convertit une entité PointOfInterestEntity en DTO
     */
    public PointOfInterestDTO toDto(PointOfInterestEntity entity) {
        if (entity == null) {
            return null;
        }
    ...
    /**
     * Convertit un DTO en entité PointOfInterestEntity
     */
    public PointOfInterestEntity toEntity(PointOfInterestDTO dto) {
        if (dto == null) {
            return null;
        }
     ...
     */
    public PointOfInterestEntity updateEntityFromDto(PointOfInterestEntity existingEntity, PointOfInterestDTO dto) {
