...
public class PoiReviewController {
        ...
        public Mono<ResponseEntity<PoiReviewDTO>> createReview(
                        @Valid @RequestBody(description = "Data for the review to create", required = true, content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = PoiReviewDTO.class))) @org.springframework.web.bind.annotation.RequestBody PoiReviewDTO reviewDTO) {
        ...
        public Mono<ResponseEntity<PoiReviewDTO>> getReviewById(
                        @Parameter(description = "Unique ID of the review", required = true, example = "123e4567-e89b-12d3-a456-426614174000") @PathVariable UUID reviewId) {
        ...
        public Flux<PoiReviewDTO> getReviewsByPoiId(
                        @Parameter(description = "Unique ID of the POI", required = true, example = "123e4567-e89b-12d3-a456-426614174000") @PathVariable UUID poiId) {
        ...
        public Flux<PoiReviewDTO> getReviewsByUserId(
                        @Parameter(description = "Unique ID of the user", required = true, example = "123e4567-e89b-12d3-a456-426614174000") @PathVariable UUID userId) {
        ...
        public Flux<PoiReviewDTO> getReviewsByOrganizationId(
                        @Parameter(description = "Unique ID of the organization", required = true, example = "123e4567-e89b-12d3-a456-426614174000") @PathVariable UUID organizationId) {
        ...
        public Mono<ResponseEntity<PoiReviewDTO>> updateReview(
                        @Parameter(description = "Unique ID of the review to update", required = true, example = "123e4567-e89b-12d3-a456-426614174000") @PathVariable UUID reviewId,
                        @Valid @RequestBody(description = "New data for the review", required = true, content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = PoiReviewDTO.class))) @org.springframework.web.bind.annotation.RequestBody PoiReviewDTO reviewDTO) {
        ...
        public Mono<ResponseEntity<Void>> deleteReview(
                        @Parameter(description = "Unique ID of the review to delete", required = true, example = "123e4567-e89b-12d3-a456-426614174000") @PathVariable UUID reviewId) {
        ...
        @Operation(summary = "Dislike a review", description = "Increments the dislike counter for a review")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Dislike added successfully", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = PoiReviewDTO.class))),
                        @ApiResponse(responseCode = "404", description = "Review not found", content = @Content)
        })
